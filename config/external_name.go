...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"scaleway_iam_saml":                                           config.NameAsIdentifier,
	"scaleway_interlink_routing_policy":                           config.NameAsIdentifier,
	"scaleway_interlink_link":                                     config.NameAsIdentifier,
	"scaleway_cockpit_exporter":                                   config.NameAsIdentifier,
	"scaleway_object_bucket_server_side_encryption_configuration": config.NameAsIdentifier,
